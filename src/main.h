...
inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 15 * 60; }
inline int64_t FutureDriftV2(int64_t nTime) { return nTime + 15 * 60; }
inline int64_t FutureDrift(int64_t nTime, int nHeight) { return IsProtocolV2(nHeight) ? FutureDriftV2(nTime) : FutureDriftV1(nTime); }

inline unsigned int GetTargetSpacing(int nHeight) { return IsProtocolV2(nHeight) ? 60 : 60; }

static const int64_t COIN_YEAR_REWARD = 0.10 * COIN;  // 10% annual interest
