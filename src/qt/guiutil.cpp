...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "OPTION.lnk";
}
...
{
    return GetAutostartDir() / "option.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("OPTION-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  option-qt [" + tr("command-line options") + "]                     " + "\n";
